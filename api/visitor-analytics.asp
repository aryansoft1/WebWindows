...
Dim ipAddress, trustGeo, countryCode, countryName, regionName, cityName
ipAddress = Cut(Request.ServerVariables("REMOTE_ADDR"), 45)
trustGeo = EnvironmentFlag("WEBWINDOWS_ANALYTICS_TRUST_IIS_GEO")
countryCode = ""
countryName = ""
regionName = ""
cityName = ""
If trustGeo Then
  countryCode = ServerGeo("GEOIP_COUNTRY_CODE")
  countryName = ServerGeo("GEOIP_COUNTRY_NAME")
  regionName = ServerGeo("GEOIP_REGION_NAME")
  cityName = ServerGeo("GEOIP_CITY")
End If
