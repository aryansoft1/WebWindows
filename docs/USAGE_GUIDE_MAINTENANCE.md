...
| 照相机与扫描 | `camera-scan` | 相机流程图 | 授权、拍摄/选图、识别、保存 | camera vertical slice |
...
- 当前聚合发布分支可确认：自然语言文件查询、公共/私人/授权设备来源、私人上传与目录管理、受控文件预览、Office 打开/另存、DeskTalk 联系人/文字聊天/AI 与受控文件工具、讯筒界面、功能目录、Developer Studio、APlay 云媒体、照相机与扫描、设备状态和网络测速。
- “照相机与扫描”已纳入注册表和本向导覆盖；相机、文档处理、二维码、OCR 与翻译仍受浏览器设备能力和权限影响。
