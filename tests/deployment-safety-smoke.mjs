...
assert.match(deploy, /AdoptChangedProductionFiles/);
assert.match(deploy, /AuditOnly/);
assert.match(deploy, /Cannot adopt a file outside this release manifest/);
assert.match(deploy, /Cannot adopt a changed file outside this release manifest/);
assert.match(deploy, /adopting_unrecorded_production_file/);
assert.match(deploy, /adopting_changed_production_file/);
assert.match(deploy, /audit_ok=true/);
assert.match(deploy, /release_match=/);
