import { e as w, U as F, a as P, M as v, l as f, t as M, R as O } from "./monaco-runtime-D4730T7L.js";
import { c as K } from "./workers-Dure_1W5.js";
class E {
  constructor(e, t) {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = K({
      // module that exports the create() method and returns a `TypeScriptWorker` instance
      moduleId: "vs/language/typescript/tsWorker",
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "" + new URL("ts.worker-vVNEBeBl.js", import.meta.url).href,
        import.meta.url
      ), { type: "module" }),
      label: this._modeId,
      keepIdleModels: !0,
