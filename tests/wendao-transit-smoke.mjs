...
assert.match(html, /transit-providers\.js\?v=20260925-15/);
assert.match(html, /transit-app\.js\?v=20260925-15/);
assert.match(html, /navigation-app\.js\?v=20260925-3/);
assert.match(html, /navigation\.css\?v=20260925-4/);
assert.doesNotMatch(html, /transit-providers\.js\?v=20260925-14/);
assert.doesNotMatch(html, /transit-providers\.js\?v=20260924-6/);
assert.doesNotMatch(html, /transit-app\.js\?v=20260925-14/);
